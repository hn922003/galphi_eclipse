...
<form class="m-3" action="deletecommentOK2.jsp" method="post" name="commentForm">
	<table class="table table-hover" style="width: 700px; margin-left: auto; margin-right: auto;">
		...
		<tr>
			...
			<td style="width: 250px;">
				<input id="score" class="form-control form-control-sm" type="text" name="score" readonly="readonly" value="${co.score}"/>
			</td>
			<th class="align-middle text-center" style="width: 100px;">
