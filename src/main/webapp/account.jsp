...
<body>
	<form action="account_insert.jsp" method="post"
		...
		<table width="500" border="1" cellpadding="5" cellspacing="0">
			...
			<tr>
				<th width="150">이메일</th>
				<td width="350"><input class="mail" type="text" name="id" /> 
			...
			<tr>
				<th>닉네임</th>
				<td><input class="input" type="text" name="nickname"
					placeholder="닉네임을 입력하세요" /> <input class="nickname_chk"
					type="button" name="nickname_chk" value="중복확인"
					onclick="nickCheck()">
			...
			<tr>
				...
				<td><input class="input" type="password" name="repassword"
					placeholder="비밀번호를 한번 더 입력하세요" onkeyup="pwCheck()" />
			...
			<tr>
				<td colspan="2" align="center"><input type="submit" value="가입" />
					...
					onclick="location.href='main_page.jsp'" /></td>
			</tr>
		</table>
	</form>
